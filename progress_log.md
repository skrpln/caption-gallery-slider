...
- Добавлен adaptive rail mode: больше `15` элементов или нехватка ширины переключают навигацию в ползунок без точек.
...
Осталось:
- Перейти к Phase 3 Top Navigation.
...
Сессия завершена результативно: уплотнён rendered caption, сохранена иерархия Markdown-заголовков, top navigation стала hover-only и получила rail mode для длинных галерей. Phase 2 закрыта оператором. Подробности: [[log/2026-05-27_00-48_phase-2-hardening-and-close]].
